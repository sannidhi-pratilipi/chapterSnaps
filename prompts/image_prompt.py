...
CINEMATIC_STYLE = (
    ...
    "including people in the background. The cast description names the "
    "region each person is from; the faces of one part of India are not "
    "the faces of another, so render the features, hair and complexion "
    "that region actually has, across its true range, rather than one "
    "light-skinned face used for everybody.\n"
    "- Clothing belongs to that same region and community: the garments "
    "named in the WEARING text, draped and worn the way they are worn "
    "there, with the jewellery, marks and hairstyles that go with them. "
    "Never substitute the dress of a different part of the country.\n"
