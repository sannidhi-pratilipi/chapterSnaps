...
CHARACTER_BIBLE_SYSTEM_PROMPT = (
    ...
    "story it is. Start from the language it is written in, which is the "
    "strongest clue there is: a story written in one Indian language is "
    "almost always set among the people who speak it, and they are a "
    "particular people in a particular part of the country, not a generic "
    "Indian. Hindi points to the north, Tamil to Tamil Nadu, Bengali to "
    "Bengal, Marathi to Maharashtra, Telugu to the Telugu states, Kannada "
    "to Karnataka, Malayalam to Kerala, Gujarati to Gujarat, Punjabi to "
    "Punjab, Odia to Odisha, Assamese to Assam, and so on for whichever "
    "language this is. Confirm it against the names and surnames, the "
    "kinship terms and honorifics, the place names, the food, the "
    "festivals and deities, and the clothing the text mentions — and follow "
    "those instead where they point somewhere else, as with a family living "
    "away from home.\n"
    "Then let that decide how these people look and dress. Faces, "
    "complexions, hair and build differ across these regions, and so do the "
    "garments, their names, the jewellery, and the marks worn on the face "
    "and in the hair. Give this story's people the features and the "
    "clothing that region genuinely has, named as they are named there, so "
    "a reader from that place would recognise them. Use the true range of "
    "complexions found there, which for most of India runs well beyond "
    "fair, rather than defaulting everyone to a light-skinned, "
    "sharp-featured face that belongs to no region in particular. Describe a "
    "complexion as it actually looks, and spread the cast across the range "
    "that region really has instead of giving everyone the same shade. Avoid "
    "the evasive words — wheatish, dusky, medium-tan, sun-kissed — which are "
    "used to sidestep naming a complexion rather than to describe one. Every "
    "character belongs to that world unless the text clearly says "
    "otherwise.\n\n"
    ...
    "specific garments, colors, fabrics, belonging to the region you "
    "established above and called by the names used there, true to their "
    "standing, "
    ...
    "dresses. Name the garment as it is named in that region, and describe "
    "it fully — the fabric, the colour, how it is draped or fastened, and "
    "the jewellery or hair ornaments that go with it. Never answer in two "
    "words. Reaching for the most familiar Indian garments whatever the "
    "setting is what makes every book look the same, so ask what a person "
    "of this age, gender, community and standing actually puts on in THIS "
    "region on an ordinary day. This is a fallback and a later chapter may "
    "change the garments, but it never undresses them.\n\n"
